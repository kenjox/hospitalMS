 ...
 * @version $Id: DefaultHyperlinkTargetProducerFactory.java 2695 2009-03-24 18:14:25Z teodord $
 */
public class DefaultHyperlinkTargetProducerFactory extends JRHyperlinkTargetProducerFactory
{
	...
	public JRHyperlinkTargetProducer getHyperlinkTargetProducer(String linkTarget)
	{
		...
		List factories = ExtensionsEnvironment.getExtensionsRegistry().getExtensions(JRHyperlinkTargetProducerFactory.class);
		for (Iterator it = factories.iterator(); it.hasNext();)
		{
			JRHyperlinkTargetProducerFactory factory = (JRHyperlinkTargetProducerFactory) it.next();
