 ...
 * @version $Id: StretchApp.java 2692 2009-03-24 17:17:32Z teodord $
 */
public class StretchApp
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			{
				JasperFillManager.fillReportToFile(fileName, null, new JREmptyDataSource(20));
			...
			{
				JasperRunManager.runReportToPdfFile(fileName, null, new JREmptyDataSource(20));
	...
	private static void usage()
	{
		...
		System.out.println( "\tjava StretchApp task file" );
