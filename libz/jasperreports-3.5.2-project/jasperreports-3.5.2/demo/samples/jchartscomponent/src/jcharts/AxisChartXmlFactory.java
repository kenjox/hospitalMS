 ...
 * @version $Id: AxisChartXmlFactory.java 2692 2009-03-24 17:17:32Z teodord $
 */
public class AxisChartXmlFactory extends JRBaseFactory
{
	...
	public Object createObject(Attributes attrs) throws Exception
	{
		...
		String areacolor = attrs.getValue("areaColor");
		chart.setAreaColor(JRXmlConstants.getColor(areacolor, null));
