 ...
 * @version $Id: PieChartFillFactory.java 2692 2009-03-24 17:17:32Z teodord $
 */
public class PieChartFillFactory implements ComponentFillFactory
{

	public FillComponent toFillComponent(Component component,
			JRFillObjectFactory factory)
	{
		return new FillPieChart((PieChartComponent) component, factory);
	}
