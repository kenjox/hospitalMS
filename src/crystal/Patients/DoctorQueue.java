 ...
 * DoctorQueue.java
 *
 * Created on Mar 30, 2011, 2:06:21 PM
 */
...
public class DoctorQueue extends javax.swing.JDialog {

    String sqlTable = "Select * from patient, queue where patient.Patient_ID = queue.patient_ID AND queue.seenNurse = 1 AND queue.seenDoctor = 0 " +
    ...
    /** Creates new form DoctorQueue */
    public DoctorQueue(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocation((screen.width - getWidth())/2,((screen.height-getHeight())/2)-65);
    }

    public DoctorQueue(Home aThis, boolean b, int userID) {
        super(aThis, b);
        initComponents();
        UserID = userID;
        setLocation((screen.width - getWidth())/2,((screen.height-getHeight())/2)-65);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTable1.isRowSelected(jTable1.getSelectedRow()) == false){
            ...
            new Diagnose(this, true, id).setVisible(true);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DoctorQueue dialog = new DoctorQueue(new javax.swing.JFrame(), true);
    ...
    public void refresh() {
        sqlTable = "Select * from patient, queue where patient.Patient_ID = queue.patient_ID AND queue.seenNurse = 1 AND queue.seenDoctor = 0 " +
            "ORDER BY queue.queue_ID ASC";
        try{
            jTable1 = Domains.getTable(header, columns, sqlTable);
            jScrollPane1.getViewport().removeAll();
